    ...
    <main className="shell">
      <section className="panel full">
        <div className="mission-cluster" style={{ justifyContent: 'flex-start', marginBottom: 16 }}>
          ...
          <Badge>Release 1-3 active</Badge>
          <Badge tone="green">Emma OCC preserved</Badge>
        </div>
        <p className="eyebrow">NOVA operating system</p>
        <h1>Foundation, Personal Core, and Life Domains</h1>
        <p>
          Releases 1 through 3 keep Emma OCC as the active mission-control module while establishing the roadmap, privacy guardrails,
          provider boundaries, identity layer, opt-in memory controls, and life-domain context for the larger NOVA personal operating system.
        </p>
      ...
      <section className="summary-grid" style={{ marginTop: 16 }}>
        ...
        <article className="panel metric">
          ...
          <p>Release 1 through 3 architecture requirements represented.</p>
        </article>
        <article className="panel metric">
